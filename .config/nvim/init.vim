...
nmap <nowait><Leader>a [fzf-p]
xmap <nowait><Leader>a [fzf-p]
...
nnoremap <silent> [fzf-p]am    :<C-u>CocCommand fzf-preview.MruFiles<CR>
nnoremap <silent> [fzf-p]mk    :<C-u>CocCommand fzf-preview.Marks<CR>
nnoremap <silent> [fzf-p]r     :<C-u>CocCommand fzf-preview.CocReferences<CR>
nnoremap <silent> [fzf-p]ad    :<C-u>CocCommand fzf-preview.CocDiagnostics<CR>
nnoremap <silent> [fzf-p]d    :<C-u>CocCommand fzf-preview.CocCurrentDiagnostic<CR>
...
" noremap <silent> [fzf-p]l     :<C-u>CocCommand fzf-preview.LocationList<CR>
...
let g:fzf_preview_mru_limit = 800
...
" Set floating window border line color to black, and background to black
hi FloatermBorderNC guibg=black guifg=black
